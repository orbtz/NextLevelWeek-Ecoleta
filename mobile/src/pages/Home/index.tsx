      ...
      <View style={styles.main}>
        <Image source={require('../../assets/logo.png')} />
          <View>
            ...
            <Text style={styles.description}>Ajuamos pessoas a entrsdkjsfafsf</Text>
          </View>
      </View>

      <View style={styles.footer}>

      <TextInput style={styles.input} placeholder='Digite a UF' value={uf} onChangeText={text => setUf(text) } autoCapitalize='characters' autoCorrect={false} />

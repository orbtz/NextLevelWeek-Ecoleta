...
const CreatePoint = () =>{
    ...
    //API externa para carregar municípios baseados na UF selecionada
    useEffect(() => {
        if (selectedUf === '0'){
            return
        }
    ...
    //Função para pegar o UF selecionada pelo usuário
    function handleSelectUf(event: ChangeEvent<HTMLSelectElement>){
        const uf = event.target.value;
        setSelectedUf(uf);
    }

    //Função para pegar a cidade selecionada pelo usuário
    ...
    //Função para pegar os items selecionados
    ...
    //Função para o click do usuário no mapa
